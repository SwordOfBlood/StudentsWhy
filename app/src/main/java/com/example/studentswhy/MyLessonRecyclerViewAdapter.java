...
import com.example.studentswhy.LessonFragment.OnListFragmentInteractionListener;
...
public class MyLessonRecyclerViewAdapter extends RecyclerView.Adapter<MyLessonRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText(mValues.get(position).getDate()+ "\n" +
                mValues.get(position).getDayOfWeekString()+ "\n" +
                mValues.get(position).getBeginLesson());
        holder.mContentView.setText(mValues.get(position).getDiscipline()+ "\n" +
                mValues.get(position).getKindOfWork()+ "\n" +
                mValues.get(position).getBuilding()+ "\n" +
                mValues.get(position).getAuditorium()+ "\n" +
                mValues.get(position).getLecturer());
